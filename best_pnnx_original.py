...
class Model(nn.Module):
    def __init__(self):
        ...
        self.model_22_cv3_0_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_48 = nn.SiLU()
        self.model_22_cv3_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_49 = nn.SiLU()
        self.model_22_cv3_0_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(1,1), out_channels=81, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_22_cv3_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=128, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_52 = nn.SiLU()
        self.model_22_cv3_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_53 = nn.SiLU()
        self.model_22_cv3_1_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(1,1), out_channels=81, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_22_cv3_2_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=256, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_56 = nn.SiLU()
        self.model_22_cv3_2_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(3,3), out_channels=81, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_57 = nn.SiLU()
        self.model_22_cv3_2_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=81, kernel_size=(1,1), out_channels=81, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        archive = zipfile.ZipFile('C:\Users\ADMINI~1\AppData\Local\Temp\ncnn_export_fx11a4n7\best.pnnx.bin', 'r')
        ...
        self.model_22_cv3_0_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.0.conv.bias', (81), 'float32')
        self.model_22_cv3_0_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.0.conv.weight', (81,64,3,3), 'float32')
        self.model_22_cv3_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.1.conv.bias', (81), 'float32')
        self.model_22_cv3_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.1.conv.weight', (81,81,3,3), 'float32')
        self.model_22_cv3_0_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.2.bias', (81), 'float32')
        self.model_22_cv3_0_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.0.2.weight', (81,81,1,1), 'float32')
        ...
        self.model_22_cv3_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.0.conv.bias', (81), 'float32')
        self.model_22_cv3_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.0.conv.weight', (81,128,3,3), 'float32')
        self.model_22_cv3_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.1.conv.bias', (81), 'float32')
        self.model_22_cv3_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.1.conv.weight', (81,81,3,3), 'float32')
        self.model_22_cv3_1_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.2.bias', (81), 'float32')
        self.model_22_cv3_1_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.1.2.weight', (81,81,1,1), 'float32')
        ...
        self.model_22_cv3_2_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.0.conv.bias', (81), 'float32')
        self.model_22_cv3_2_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.0.conv.weight', (81,256,3,3), 'float32')
        self.model_22_cv3_2_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.1.conv.bias', (81), 'float32')
        self.model_22_cv3_2_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.1.conv.weight', (81,81,3,3), 'float32')
        self.model_22_cv3_2_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.2.bias', (81), 'float32')
        self.model_22_cv3_2_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.cv3.2.2.weight', (81,81,1,1), 'float32')
        self.model_22_dfl_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.22.dfl.conv.weight', (1,16,1,1), 'float32')
        self.pnnx_99_data = self.load_pnnx_bin_as_parameter(archive, 'pnnx_99.data', (1,8400,), 'float32')
    ...
    def forward(self, v_0):
        ...
        v_142 = torch.cat((v_136, v_141), dim=1)
        v_143 = self.model_22_cv2_1_0_conv(v_116)
        v_144 = self.pnnx_unique_50(v_143)
        v_145 = self.model_22_cv2_1_1_conv(v_144)
        v_146 = self.pnnx_unique_51(v_145)
        v_147 = self.model_22_cv2_1_2(v_146)
        v_148 = self.model_22_cv3_1_0_conv(v_116)
        v_149 = self.pnnx_unique_52(v_148)
        v_150 = self.model_22_cv3_1_1_conv(v_149)
        v_151 = self.pnnx_unique_53(v_150)
        v_152 = self.model_22_cv3_1_2(v_151)
        v_153 = torch.cat((v_147, v_152), dim=1)
        v_154 = self.model_22_cv2_2_0_conv(v_130)
        v_155 = self.pnnx_unique_54(v_154)
        v_156 = self.model_22_cv2_2_1_conv(v_155)
        v_157 = self.pnnx_unique_55(v_156)
        v_158 = self.model_22_cv2_2_2(v_157)
        v_159 = self.model_22_cv3_2_0_conv(v_130)
        v_160 = self.pnnx_unique_56(v_159)
        v_161 = self.model_22_cv3_2_1_conv(v_160)
        v_162 = self.pnnx_unique_57(v_161)
        v_163 = self.model_22_cv3_2_2(v_162)
        v_164 = torch.cat((v_158, v_163), dim=1)
        v_165 = v_142.reshape(1, 145, 6400)
        v_166 = v_153.reshape(1, 145, 1600)
        v_167 = v_164.reshape(1, 145, 400)
        v_168 = torch.cat((v_165, v_166, v_167), dim=2)
        v_169, v_170 = torch.split(tensor=v_168, dim=1, split_size_or_sections=(64,81))
        v_171 = v_169.reshape(1, 4, 16, 8400)
        v_172 = torch.transpose(v_171, dim0=2, dim1=1)
        v_173 = F.softmax(v_172, dim=1)
        v_174 = self.model_22_dfl_conv(v_173)
        v_175 = v_174.reshape(1, 4, 8400)
        v_176 = self.pnnx_fold_anchor_points_1_data
        v_177, v_178 = torch.chunk(v_175, chunks=2, dim=1)
        v_179 = (v_176 - v_177)
        v_180 = (v_176 + v_178)
        v_181 = ((v_179 + v_180) / 2)
        v_182 = (v_180 - v_179)
        v_183 = torch.cat((v_181, v_182), dim=1)
        v_184 = (v_183 * v_131)
        v_185 = F.sigmoid(v_170)
        v_186 = torch.cat((v_184, v_185), dim=1)
        return v_186
...
def export_torchscript():
    ...
    mod.save("C:\Users\ADMINI~1\AppData\Local\Temp\ncnn_export_fx11a4n7\best_pnnx.py.pt")
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "C:\Users\ADMINI~1\AppData\Local\Temp\ncnn_export_fx11a4n7\best_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "C:\Users\ADMINI~1\AppData\Local\Temp\ncnn_export_fx11a4n7\best_pnnx.py.pt", v_0)
